...
SRC = arch/cpu/entry.S arch/cpu/trampoline.S arch/bsp/print_functions.c arch/bsp/handlers.c arch/bsp/sys_timer.c kernel/start.c arch/bsp/uart.c arch/bsp/kprintf.c
